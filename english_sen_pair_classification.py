...
flags.DEFINE_string("task_name", "sen_pair", "The name of the task to train.")
...
class MyProcessor(DataProcessor):
  """Processor for the Chinese sentence pair data set."""
